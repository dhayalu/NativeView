...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, weak) id <GenericTagDelegate> _Nullable genericTag;)
...
- (void)getValueWithName:(NSString * _Nonnull)name;
- (void)onFalureLogsWithData:(NSString * _Nonnull)data;
@end
...
@property (nonatomic, copy) NSString * _Nonnull url;
@property (nonatomic) BOOL preCacheContacts;
- (nonnull instancetype)initWithApplicationName:(NSString * _Nullable)applicationName baseUrl:(NSString * _Nonnull)baseUrl institutionId:(NSString * _Nonnull)institutionId product:(NSString * _Nonnull)product ssoKey:(NSString * _Nonnull)ssoKey title:(NSString * _Nonnull)title bgColor:(NSString * _Nullable)bgColor loaderData:(NSDictionary<NSString *, NSString *> * _Nullable)loaderData parameters:(NSDictionary<NSString *, NSString *> * _Nonnull)parameters OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
